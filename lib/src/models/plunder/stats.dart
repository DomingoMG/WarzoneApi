...
class Stats {
  ...
  static Stats fromMap( Map<String, dynamic> json ) => Stats(
    ...
    weeklyKillsPerGame: WeeklyKillsPerGame.fromMap( json['weeklyKillsPerGame'] ),
    weeklyScorePerMinute: WeeklyScorePerMinute.fromMap( json['weeklyScorePerMinute'] ),
    weeklyScorePerGame: WeeklyScorePerGame.fromMap( json['weeklyScorePerGame'] ),
    weeklyKdRatio: WeeklyKdRatio.fromMap( json['weeklyKdRatio'] ),
    weeklyHeadshotPct: WeeklyHeadshotPct.fromMap( json['weeklyHeadshotPct'] ),
    weeklyMatchesPlayed: WeeklyMatchesPlayed.fromMap( json['weeklyMatchesPlayed'] ),
    weeklyDamageDone: WeeklyDamageDone.fromMap( json['weeklyDamageDone'] ),
    weeklyDamagePerMatch: WeeklyDamagePerMatch.fromMap( json['weeklyDamagePerMatch'] ),
    weeklyDamagePerMinute: WeeklyDamagePerMinute.fromMap( json['weeklyDamagePerMinute'] )
  );
