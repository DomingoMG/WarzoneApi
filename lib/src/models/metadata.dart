...
class LastUpdated {
  ...
  factory LastUpdated.fromMap( Map<String, dynamic> json ) => LastUpdated(
    value: json['value'],
...
class OtherTitles {
  ...
  factory OtherTitles.fromMap( Map<String, dynamic> json ) => OtherTitles(
    warzone: Warzone.fromMap( json['warzone'] )
  );

  Map<String, dynamic> toMap() => {
    'warzone': warzone?.toMap()
  };
